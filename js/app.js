    ...
    (() => {
        ...
        function formSubmit(options = {
            ...
            function formSent(form, responseResult = ``) {
                ...
                if (forms.length) formValidate.formClean(form);
        ...
        function initSliders() {
            if (document.querySelector(".slider-main__body  ")) new core(".slider-main__body", {
                ...
                parallax: true,
                pagination: {
                    el: ".controls-slider-main__pagination",
                    clickable: true
                },
                navigation: {
        ...
        if (document.querySelector(".search-header")) {
            ...
            if (search.offsetWidth <= 300) {
                search.classList.add("_small-search");
                document.querySelector(".icon-header__search").style.display = "block";
            }
        }
        ...
        function documentActions(e) {
            ...
            if (targetElement.classList.contains("icon-header__search")) {
                document.querySelector(".search-header").classList.toggle("_active");
                targetElement.closest(".icon-header__search").classList.toggle("_active");
            }
            if (!targetElement.closest(".search-header") && !targetElement.classList.contains("icon-header__search") && document.querySelectorAll(".search-header._active").length > 0) {
                removeClasses(document.querySelectorAll(".icon-header__search._active"), "_active");
                removeClasses(document.querySelectorAll(".search-header._active"), "_active");
            }
            if (!targetElement.closest(".menu") && document.documentElement.classList.contains("menu-open") && !targetElement.classList.contains(".icon-menu")) menuClose();
        }
        const header = document.querySelector(".header");
        const first = document.querySelector(".main-slider");
